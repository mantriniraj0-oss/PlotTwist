    ...
    <main className="flex-1 w-full max-w-md mx-auto pt-32 pb-24 px-5 flex flex-col gap-6 relative z-10">
      ...
      <section className="text-center flex flex-col items-center pt-2">
        ...
        <div className="inline-flex items-center gap-1.5 px-3 py-1 bg-surface-container-lowest border-2 border-outline shadow-[2px_2px_0px_#1a1a1a] mb-3">
          ...
          <span className="text-[11px] font-bold text-on-surface font-headline uppercase">National Cadastral Sync Active</span>
        ...
        <h1 className="font-headline text-2xl font-bold text-primary tracking-tight leading-tight uppercase border-b-4 border-primary pb-1">
          Cabinet Executive Overview
        </h1>
        <p className="font-sans text-[13px] text-on-surface-variant mt-2 max-w-xs font-medium leading-relaxed">
          Unified Decision Support & Cadastral Monitoring per RFCTLARR statutory framework.
        </p>
      </section>
      ...
      <section>
        <form className="relative" onSubmit={e => e.preventDefault()}>
          <div className="relative flex items-center bg-surface-container-lowest border-2 border-outline shadow-[4px_4px_0px_#1a1a1a] p-1.5 pl-3.5">
            ...
            <input className="w-full bg-transparent text-[13px] text-on-surface placeholder:text-outline font-medium focus:outline-none py-1" placeholder="Verify Khasra, Survey No. or Award ID..." type="text" />
      ...
      <section className="flex flex-col gap-4">
        <div className="relative p-5 bg-surface-container-lowest border-2 border-outline shadow-[4px_4px_0px_#1a1a1a]">
          <div className="flex items-start justify-between mb-4 border-b-2 border-outline pb-2">
            <div>
              <span className="text-[10px] font-bold font-headline tracking-wider uppercase bg-secondary text-on-secondary px-1.5 py-0.5 border border-outline">Physical Clearance</span>
              <h2 className="font-headline font-bold text-lg text-primary leading-tight mt-1">Total Land Acquired</h2>
            </div>
          ...
          <div className="flex items-center gap-5">
            <div className="relative w-24 h-24 flex-shrink-0 flex items-center justify-center border-2 border-outline bg-surface-container">
              ...
              <div className="absolute flex flex-col items-center justify-center leading-none">
                ...
                <span className="text-[9px] font-bold font-headline tracking-wider text-on-surface uppercase mt-0.5">Cleared</span>
              </div>
            </div>
            <div className="flex-1 flex flex-col justify-center gap-2">
              <div>
                <div className="text-[11px] font-bold text-on-surface-variant uppercase">Possessed & Handed Over</div>
                <div className="flex items-baseline gap-1">
                  <span className="font-headline text-xl font-bold text-primary">1.08M</span>
                  <span className="text-[11px] text-outline font-bold">Hectares</span>
                </div>
              </div>
              <div className="h-0.5 bg-outline w-full"></div>
              <div>
                <div className="text-[10px] text-outline uppercase font-bold">Total Proposed Footprint</div>
                <div className="text-[12px] font-bold text-on-surface font-headline">1.42M Ha <span className="text-outline font-normal">across corridors</span></div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-3 gap-2.5">
          <div className="p-3 bg-surface-container-lowest border-2 border-outline shadow-[2px_2px_0px_#1a1a1a] flex flex-col justify-between">
            <div className="flex items-center justify-between text-outline mb-2">
              <span className="text-[10px] font-bold font-headline uppercase tracking-wider">Corridors</span>
            ...
            <div>
              ...
              <div className="text-[10px] text-error font-bold mt-0.5 flex items-center gap-0.5">
                ...
                <span>148 Delayed</span>
              </div>
            </div>
          </div>
          <div className="p-3 bg-surface-container-lowest border-2 border-outline shadow-[2px_2px_0px_#1a1a1a] flex flex-col justify-between">
            <div className="flex items-center justify-between text-outline mb-2">
              <span className="text-[10px] font-bold font-headline uppercase tracking-wider">Disbursed</span>
          ...
          <div className="p-3 bg-surface-container-lowest border-2 border-outline shadow-[2px_2px_0px_#1a1a1a] flex flex-col justify-between">
            <div className="flex items-center justify-between text-outline mb-2">
              <span className="text-[10px] font-bold font-headline uppercase tracking-wider">Families</span>
        ...
        <div className="p-4 bg-surface-container-lowest border-2 border-outline shadow-[4px_4px_0px_#1a1a1a] flex items-center justify-between gap-3">
          <div className="flex items-center gap-3 min-w-0">
            ...
            <div className="min-w-0">
              <h3 className="font-headline text-[13px] font-bold text-primary truncate leading-tight uppercase">Vadodara-Mumbai Corridor #08</h3>
              <p className="text-[11px] text-on-surface-variant truncate mt-0.5 font-semibold">Package 4B • 94% Clearance verified</p>
            </div>
          </div>
      ...
      <footer className="text-center pt-2 pb-1 text-on-surface-variant">
        <div className="inline-flex items-center justify-center gap-1.5 px-3 py-1 bg-surface-container-lowest border-2 border-outline shadow-[2px_2px_0px_#1a1a1a] text-[11px] font-bold text-primary font-headline">
          ...
          <span>Audited per RFCTLARR Act 2013</span>
        </div>
        <p className="text-[10px] text-outline mt-2 font-semibold uppercase tracking-wider">National Land Records Modernization • Govt of India</p>
      </footer>
    </main>
  );
}
